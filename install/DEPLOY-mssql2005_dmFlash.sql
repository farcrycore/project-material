			...
			flashWidth 
								decimal(10,2)
							NULL 
							DEFAULT 0 , catFlash nvarchar(250) NULL 
							DEFAULT NULL
						, datetimelastupdated datetime NOT NULL 
							DEFAULT {ts '2213-11-11 15:20:44'} , flashURL nvarchar(250) NULL 
							DEFAULT NULL
						...
						, flashLoop 
							...
							DEFAULT 0 , bLibrary 
								bit
							NULL 
							DEFAULT 1 , ObjectID nvarchar(50) NOT NULL 
							DEFAULT ''
						, ownedby nvarchar(250) NULL 
							DEFAULT NULL
						, lastupdatedby nvarchar(250) NOT NULL 
							DEFAULT ''
						, teaser ntext NULL , label nvarchar(250) NULL 
							DEFAULT NULL
						, flashPlay 
								bit
							NOT NULL 
							DEFAULT 1 , flashAlign nvarchar(250) NULL 
							DEFAULT 'center'
						...
						, locked 
								bit
							NOT NULL 
							DEFAULT 0 , metaKeywords nvarchar(250) NULL 
							DEFAULT NULL
