			...
			ownedby nvarchar(250) NULL 
						...
						, objectTypename nvarchar(250) NULL 
							DEFAULT NULL
						, objectWDDX ntext NULL , lastupdatedby nvarchar(250) NOT NULL 
							DEFAULT ''
						...
						, lRoles nvarchar(250) NULL 
							DEFAULT NULL
						, archiveID nvarchar(50) NULL 
							DEFAULT NULL
						, createdby nvarchar(250) NOT NULL 
							DEFAULT ''
						, datetimecreated datetime NOT NULL 
							DEFAULT {ts '2213-11-11 15:20:44'} , bDeleted 
								bit
							NULL 
							DEFAULT 0 , lockedBy nvarchar(250) NULL 
							DEFAULT NULL
						, event nvarchar(250) NULL 
							DEFAULT NULL
						, metaWDDX ntext NULL , username nvarchar(250) NULL 
							DEFAULT NULL
