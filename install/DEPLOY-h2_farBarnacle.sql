			...
			permissionid 
								varchar(50)
							NULL DEFAULT NULL , barnaclevalue 
								decimal(10,2)
							NULL DEFAULT 0 , ownedby 
								varchar(250)
							NULL DEFAULT NULL , lastupdatedby 
								varchar(250)
							NOT NULL DEFAULT '' , roleid 
								varchar(50)
							NULL DEFAULT NULL , label 
								varchar(250)
							NULL DEFAULT NULL , datetimelastupdated datetime NOT NULL DEFAULT '2213-11-11 03:20:44' , objecttype 
								varchar(250)
